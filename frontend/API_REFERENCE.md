...
```json
{ "timestamp": "ISO-8601", "status": 404, "error": "Not Found", "message": "human-readable reason" }
```
...
[
  {
    ...
    "notes": "test contact",
    "clique": { "id": 1, "name": "Test Church", "description": "A test clique" },
    "addedBy": { "id": 2, "name": "Test Manager", "email": "manager@test.com", "role": "MANAGER" },
...
- No endpoint to delete/update a clique.
